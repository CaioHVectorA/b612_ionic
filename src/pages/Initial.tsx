//@ts-nocheck
import { IonContent, IonInput, IonPage, IonSelect, IonSelectOption } from "@ionic/react"
...
const Initial: React.FC = () => {
    ...
    useEffect(() => {
        ...
        if (hasUser) {
            ...
            if (!([1001,1002,1003,1004,2001,2002,2003,2004,3001,3002,3003,3004].includes(infos.turma))) return
            setName(infos.user)
        ...
        <IonPage>
            <IonContent fullscreen>
                ...
                />
                    ...
                    <button onClick={() => hist.push('/home')} type="button" className=" mt-5 bg-main rounded-3xl py-2 text-white w-fit mx-auto px-8" style={(turma !== 0 && name) ? {} : {opacity: '.4'}}>Entrar</button>
                </ColumnContainer>
            </IonContent>
        </IonPage>
    )
